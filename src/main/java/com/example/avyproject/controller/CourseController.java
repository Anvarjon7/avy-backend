...
public class CourseController {
    ...
    ResponseEntity<CourseDto> create(@ModelAttribute CreateCourseDto createCourseDto, @RequestHeader("Authorization") String authHeader) {
        AvyUser creator = avyUserService.getUserByToken(authHeader.substring(7));
        Course course = courseService.createCourse(createCourseDto, creator);
